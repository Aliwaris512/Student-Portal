...
class FinancialCharge(Base):
    ...
    category = Column(String, nullable=True)  # tuition, fees, insurance, etc.
    status = Column(String, nullable=True)    # charged, pending, etc.
...
class FinancialPayment(Base):
    ...
    amount = Column(Float, nullable=False)
    date = Column(Date, nullable=False)
    type = Column(String, nullable=True)      # payment, loan, scholarship, etc.
    status = Column(String, nullable=True)    # completed, pending, etc.
...
class FinancialAid(Base):
    ...
    amount = Column(Float, nullable=False)
    date = Column(Date, nullable=False)
    source = Column(String, nullable=True)    # scholarship, grant, etc.
